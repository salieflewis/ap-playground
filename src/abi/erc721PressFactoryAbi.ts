export const erc721PressFactoryAbi = [
  {
    inputs: [
      { internalType: 'address', name: '_pressImpl', type: 'address' },
      { internalType: 'address', name: '_databaseImpl', type: 'address' },
    ],
  ...
  },
  {
    ...
    name: 'createPress',
    outputs: [{ internalType: 'address', name: 'press', type: 'address' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
